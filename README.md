...
**Dataset**: PriMock57 (55 files, ~80,500 words) | **Models**: 40 | **Updated**: 2026-04-07
...
| Type | Models | Setup |
|------|--------|-------|
| **API** | OpenAI, Groq, ElevenLabs, Google, Mistral, Deepgram, AssemblyAI, Soniox | Add keys to `.env` |
